                ...
                <div className="info-fields-wrap">
                    <div className="first-and-last">
                        <div className="first-name">
                            ...
                            <input type="text" placeholder="First name" defaultValue={firstname} className="input-name" />
                        </div>
                        <div className="last-name">
                            <label htmlFor="">Lastname</label>
                            <input type="text" placeholder="Last name" defaultValue={lastname} className="input-lastname" />
                        </div>
                    </div>
                    <div className="user-name-wrap">
                        <label htmlFor="" className="user-name-label">Username</label>
                        <input type="text" placeholder="Username" defaultValue={username} className="input-username" />
                    </div>
                </div>
                <div className="contact-info-wrap">
                    <div className="email-wrap">
                        <label htmlFor="" className="email-label">Email</label>
                        <input type="email" placeholder="Email" defaultValue={email} className="input-email" />
                    ...
                    <div className="phone-wrap">
                        ...
                        <input type="tel" placeholder="Phone" defaultValue={mobile} className="input-phone" />
