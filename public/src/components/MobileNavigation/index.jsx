...
export const MobileNavigation = ({updateLikedWines}) => {
    ...
    return (
        <div className="mobile-nav-wrap">
            <div className="mobile-nav">
                ...
                <button onClick={() => setShowLikedModal(!showLikedModal)} className="mob-nav-btn">
                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24" fill="none">
                    ...
                    {showLikedModal && <LikedModal updateLikedWines={updateLikedWines} />}
                </button>
                <button className="mob-nav-btn">
                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24" fill="none">
